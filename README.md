...
Now we just assume that both of  can be attained. Then, we suppose that <img src="https://latex.codecogs.com/png.latex?(U_{(k),i},Z_{(k),U_{(k)},i})" title="(U_{(k),i},Z_{(k),U_{(k)},i})" /></a> is the <img src="https://latex.codecogs.com/png.latex?i" title="i" /></a>th component of the <img src="https://latex.codecogs.com/png.latex?k" title="k" /></a>th sample, we want to draw the <img src="https://latex.codecogs.com/png.latex?i" title="i" /></a>th component of the <img src="https://latex.codecogs.com/png.latex?(k&plus;1)" title="(k+1)" /></a>th sample from these two conditional distributions. We draw
